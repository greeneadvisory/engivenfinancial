                ...
                <div className="box my-4">
                    <div className="box-body !p-[3rem]">
                        ...
                        <div className="flex mb-3 justify-between gap-2 flex-wrap flex-lg-nowrap">
                            <SpkButton Size="lg" customClass="ti-btn ti-btn-lg border border-defaultborder dark:border-defaultborder/10 flex items-center justify-center flex-auto bg-light">
