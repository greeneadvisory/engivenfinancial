                            ...
                            <div className="grid grid-cols-12 sm:gap-x-6 flex-wrap justify-center">
                                ...
                                <div className="xl:col-span-10 col-span-12">
                                   <div className="grid grid-cols-12 sm:gap-x-6">
                                    ...
                                    <div className="xl:col-span-2 col-span-12"></div>
                                    <div className="xl:col-span-4 col-span-12">
                                        <div className="box shadow-none !bg-primarytint3color/10">
                                            <div className="box-body sm:flex">
                                                <div>
                                                    <span className="avatar avatar-xl bg-primarytint3color svg-white flex-shrink-0" id="step-5"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g fillRule="evenodd"><path d="M7.95 20h13.06c1.092 0 1.99-.892 1.99-1.992V6.992A1.992 1.992 0 0 0 21.01 5H4.99C3.899 5 3 5.892 3 6.992v8.059a3.51 3.51 0 0 1 1-.714V6.992C4 6.447 4.448 6 4.99 6h16.02c.546 0 .99.445.99.992v11.016a.996.996 0 0 1-.99.992H8.662a3.51 3.51 0 0 1-.714 1Z"></path><path d="M23 10h-4.49A2.498 2.498 0 0 0 16 12.5c0 1.39 1.123 2.5 2.51 2.5H23v-1h-4.49c-.839 0-1.51-.667-1.51-1.5 0-.832.668-1.5 1.51-1.5H23v-1ZM18.747 2.465c.716-.183 1.248.234 1.246.975l-.008 2.012-.002.5 1 .004.002-.5.008-2.012c.005-1.394-1.142-2.294-2.494-1.948L4.53 5.073l-.698 1.211 14.914-3.819ZM5.5 22a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm0-1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"></path><path d="m3 17.328.707-.707 1.414 1.415 2.122-2.122.707.707L5.12 19.45z"></path></g></svg> </span>
                                                </div>
                                                <div className="sm:text-start text-center sm:ms-4 sm:mt-0 mt-2">
                                                    <h6 className="font-medium mb-2">Payment Methods</h6>
                                                    <span className="text-[12px] text-textmuted dark:text-textmuted/50">Discover attractions, create itineraries, and explore local highlights.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="xl:col-span-4 col-span-12">
                                        <div className="box shadow-none !bg-secondary/10">
                                            <div className="box-body sm:flex">
                                                <div>
                                                    <span className="avatar avatar-xl bg-secondary svg-white flex-shrink-0" id="step-6"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="approve"><path d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z"></path></svg> </span>
                                                </div>
                                                <div className="sm:text-start text-center sm:ms-4 sm:mt-0 mt-2">
                                                    <h6 className="font-medium mb-2">Confirm Booking.</h6>
                                                    <span className="text-[12px] text-textmuted dark:text-textmuted/50">Stay connected, receive real-time updates, and confirm bookings.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
