...
<Fragment>
            ...
            {/* <!-- Start:: row-1 --> */}
                ...
                <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="flex justify-center gap-4">
                              ...
                              <SpkOverlay customClass="[--trigger:click] [--placement:right] rtl:[--placement:left]">
                                <Link scroll={false} className="hs-tooltip-toggle ti-main-tooltip-toggle" href="#!">
                                  ...
                                  <div className="hs-tooltip-content ti-main-tooltip-content border border-defaultborder dark:border-defaultborder/10 hidden" role="tooltip"  data-popper-placement="right"
                                 >
                                    Right popover
                                  </div>
                                </Link>
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-6">
                        <Showcode title="Popover With Hover event" customCardClass="" customCardBodyClass="" reactCode={reactpopover10} reusableCode={reusepopover10}>
                          <div className="flex justify-center">
                ...
                <div className="grid grid-cols-12 gap-6">
                  <div className="col-span-12 lg:col-span-6 xxl:col-span-6">
                      <Showcode title="Review popover" customCardClass="" customCardBodyClass="" reactCode={reactpopover11} reusableCode={reusepopover11}>
                        {/* <!-- Popover --> */}
                        <SpkOverlay customClass="[--trigger:click]">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-6">
                        <Showcode title="User popover example" customCardClass="" customCardBodyClass="" reactCode={reactpopover12}  reusableCode={reusepopover12}>
                          {/* <!-- User --> */}
                          <div className="hs-tooltip inline-block [--trigger:hover] [--placement:top] sm:![--placement:right]">
