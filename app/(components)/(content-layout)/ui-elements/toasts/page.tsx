...
import { Colortoastdata, reacttoast1, reacttoast2, reacttoast3, reacttoast4, reacttoast5, reacttoast6, reusetoast1, reusetoast2, reusetoast3, reusetoast4, reusetoast5, reusetoast6 } from "@/shared/data/prism/utilities-prism";
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Solid Colored Toasts" reactCode={reacttoast3} reusableCode={reusetoast3} dataCode={Colortoastdata}>
                            <div className="space-y-3">
                                {ColorToasts.map((idx) => (
                                    <div key={idx.id}>
                                        <SpkToast Id={`dismiss-solidtoast-${idx.id}`} customClass={`ti-toast bg-${idx.color2} text-sm text-white hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300`} >
                                            <div className="flex p-4">
                                                ...
                                                <div className="ms-auto">
                                                    <SpkButton buttontype="button"
                                                        ...
                                                        text-sm dark:focus:ring-offset-white/10 dark:focus:ring-white/10" removeelement={`#dismiss-solidtoast-${idx.id}`}>
                                                        <span className="sr-only">Close</span>
