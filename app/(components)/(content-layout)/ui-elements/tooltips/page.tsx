...
import { reacttooltip1, reacttooltip2, reacttooltip3, reacttooltip4, reacttooltip5, reacttooltip6, reusetooltip1, reusetooltip2, reusetooltip3, reusetooltip4, reusetooltip5, reusetooltip6, tooltipdata2 } from "@/shared/data/prism/utilities-prism";
                        ...
                        <Showcode title="Tooltips on Links" reactCode={reacttooltip3} reusableCode={reusetooltip3}>
                            <SpkOverlay customClass="[--placement:top]">
                                <p className="text-muted mb-0">
                                    Hover on the link to view the <a aria-label="anchor" href="#!"
