                    ...
                    <div className="col-span-12 lg:col-span-6">
                        <div className="box">
                            ...
                            <div className="box-body">
                                <div className="relative">
                                    <div className="relative rounded-sm overflow-auto">
                                      <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-6 gap-4 font-mono text-defaulttextcolor text-sm text-center font-bold mb-2">
