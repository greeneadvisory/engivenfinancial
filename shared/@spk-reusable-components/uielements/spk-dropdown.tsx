  ...
  return (
    <Fragment>
        <div className={`hs-dropdown ti-dropdown  ${Customclass}`}>
                {Linktag ? 
                    useButtonToggle ? (
                      <button type="button" className={Linkclass} aria-expanded={arialexpand} aria-label="anchor" id={toggleId}>
                        {toggleContent}
                      </button>
                    ) : (
                      <Link scroll={false} href={navigateTo} className={Linkclass} aria-expanded={arialexpand} aria-label="anchor" id={toggleId}>
                        {toggleContent}
                      </Link>
                    )
                  :
