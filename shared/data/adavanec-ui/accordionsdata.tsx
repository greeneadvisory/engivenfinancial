...
export const Borderedaccordion=[
  {
    ...
    Svgclass:'size-4',
    Svgclass1:'size-4',
    Customclass:'active bg-white border -mt-px first:rounded-t-lg last:rounded-b-lg dark:bg-bodybg dark:border-white/10 overflow-hidden',
...
},
{
  ...
  Svgclass:'size-4',
  Svgclass1:'size-4',
  Customclass:'bg-white border -mt-px first:rounded-t-lg last:rounded-b-lg dark:bg-bodybg dark:border-white/10 overflow-hidden',
  content: <div className="pb-4 px-5 dark:bg-bodybg">
  <p className="text-gray-800 dark:text-gray-200">
    <em>This is the third item's accordion body.</em> It is
    hidden by default, until the collapse plugin adds the
...
export const Arrowbasicstretched=[
  {
    ...
    Svgclass:'size-4',
    Svgclass1:'size-4',
    Customclass:'accordion-item  overflow-hidden !border-b-0 active',
