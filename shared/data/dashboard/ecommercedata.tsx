...
export const Ecommercecard = [
  ...
  { id: 2, title: "Revenue", count: "$245,147", inc: "Increased By", percentageChange: "0.6%", icon: "ti ti-trending-up", svgIcon: svg2, backgroundColor: "primarytint1color svg-white", color: "success" },
  { id: 3, title: "Average Order Value", count: "$120", inc: "Decreased By", percentageChange: "1.08%", icon: "ti ti-trending-down", svgIcon: svg3, backgroundColor: "primarytint2color  svg-white", color: "danger" },
  { id: 4, title: "Total Orders", count: "1,25,032", inc: "Increased By", percentageChange: "2.3%", icon: "ti ti-trending-up", svgIcon: svg4, backgroundColor: "primarytint3color  svg-white", color: "success" },
]
...
export const Payment = [
  { id: 1, icon: "ri-bank-card-line", title: ' Credit Card', percent: '25%', color: 'primarytint3color' },
  { id: 2, icon: "ri-paypal-line", title: 'PayPal', percent: '20%', color: 'primarytint2color' },
  { id: 3, icon: "ri-visa-line", title: 'VISA', percent: '15%', color: 'primarytint1color' },
...
export const Recentactivity = [
  {
    ...
    Duration: "3 hrs ago",
    DurationClass: 'block text-textmuted dark:text-textmuted/50 text-[11px] opacity-70'
  },
  {
    Id: 2,
    IconSize: "avatar-sm",
  ...
  },
  {
    Id: 3,
    IconSize: "avatar-sm",
    Iconclass: "bg-primarytint1color ",
