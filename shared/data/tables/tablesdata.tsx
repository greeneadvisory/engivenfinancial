...
export const Table12data: table10[] = [
    ...
    { id: 3, text1: "This cell inherits", text2: " from the table", text3: "This cell is aligned to the top.", text4: "", class1: "!border-b  border-defaultborder dark:border-defaultborder/10", class2: "border-b dark:border-defaultborder/10 border-defaultborder align-top !whitespace-normal", code1: "vertical-align: middle;", code2: "" },
