...
export const MENUITEMS: any = [
  ...
  },
  {
    ...
    children: [
      {
        path: "/npos/master-npo-list",
        type: "link",
        active: false,
        selected: false,
        title: "Master NPO List",
      },
      {
        path: "/npos/npo-updates",
        type: "link",
        active: false,
        selected: false,
        title: "NPO Updates",
    ...
    children: [
      {
        ...
        active: false,
        selected: false,
        title: "CA DOJ Charities",
        children: [
          {
            path: "/other/ca-doj-charities/combined-trans-org-summary",
            type: "link",
            active: false,
            selected: false,
            title: "Combined Trans Org Summary",
          },
          {
            path: "/other/ca-doj-charities/crypto-trans-org-summary",
            type: "link",
            active: false,
            selected: false,
            title: "Crypto Trans Org Summary",
          },
          {
            path: "/other/ca-doj-charities/stock-trans-org-summary",
            type: "link",
            active: false,
            selected: false,
            title: "Stock Trans Org Summary",
          },
        ],
      },
    ],
